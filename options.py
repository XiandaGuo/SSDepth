...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--use_cvt_dev",
                                 help="use cvt_dev",
                                 action="store_true")

        self.parser.add_argument("--use_thratt",
                                 help="use thratt",
                                 action="store_true")

        self.parser.add_argument("--use_selfatt",
                                 help="use selfatt",
                                 action="store_true")

        self.parser.add_argument("--use_crossatt",
                                 help="use crossatt",
                                 action="store_true")

        # random six pic
        self.parser.add_argument("--rand_six_pic",
                                 help="random six pic",
                                 action="store_true")
        # eval
        self.parser.add_argument("--eval_w",
                                 type=int,
                                 help="eval w",
                                 default=1600)
        self.parser.add_argument("--eval_h",
                                 type=int,
                                 help="ord num",
                                 default=900)
        ...
        self.parser.add_argument("--path_num",
                                 type=int,
                                 help="trans path num",
                                 default=0)

        self.parser.add_argument("--encoder_option",
                                 type=str,
                                 help="encoder",
                                 default='resnet')
        # paraNet
        self.parser.add_argument("--use_lrview",
                                 help="use paraNet",
                                 action="store_true")
        ...
        # bts
        self.parser.add_argument("--model_option",
                                 type=str,
                                 help="model name",
                                 default='surr')
        ...
        self.parser.add_argument("--loss_option",
                                 type=str,
                                 help="loss option",
                                 default='abs')
        self.parser.add_argument("--use_disp_to_depth",
                                 help="use or not use disp_to_depth",
                                 action="store_true")
        self.parser.add_argument("--use_sfm_loss",
                                 help="use or not use disp_to_depth",
                                 action="store_true")
        self.parser.add_argument("--use_only_final_loss",
                                 help="only use final layer loss",
                                 action="store_true")
        self.parser.add_argument("--use_cvt",
                                 help="cvt",
                                 action="store_true")
        self.parser.add_argument("--use_cross_view",
                                 help="use cross view",
                                 action="store_true")
