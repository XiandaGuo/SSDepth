...
class DDADDataset(MonoDataset):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.depth_path = 'data/ddad/ddad_depth_val'
        # self.match_path = 'data/ddad/ddad_depth_train'
        self.rgb_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/ddad/ddad_train_val'
        self.depth_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/ddad/depth_val'
        self.match_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/ddad/depth_train'
        self.mask_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/ddad/mask'
    ...
    def get_info(self, inputs, index_temporal, do_flip):
        ...
        for index_spatial in range(6):
            ...
            # print(os.path.join(self.rgb_path, scene_id, 'rgb', self.camera_names[index_spatial], index_temporal + '.png'))
            ...
            if self.is_train:
                ...
                if self.opt.use_lidar:
                    ...
                    depth = np.load(os.path.join(self.match_path, scene_id, 'depth',
                                self.camera_names[index_spatial], index_temporal + '.npy'))
