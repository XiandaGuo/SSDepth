...
# root_path = '/mnt/goosefs/bjcar01/algorithm/public_data/ddad/ddad_train_val'
root_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/ddad/ddad_train_val'
...
root_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/ddad/depth_val'
# root_path = '../data/ddad/ddad_depth'
# root_path = '/mnt/goosefs/bjcar01/algorithm/wenjie.yuan/ddad_val'
