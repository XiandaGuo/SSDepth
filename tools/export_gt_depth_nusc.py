...
class DepthGenerator(object):
    def __init__(self):
        self.data_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/nuscenes/raw_data'
        # self.data_path = '/mnt/goosefs/bjcar01/algorithm/public_data/det3d/nuscenes/origin'
        version = 'v1.0-trainval'
        self.nusc = NuScenes(version=version,
                            dataroot=self.data_path, verbose=False)

        with open('../datasets/nusc/depth_{}_prenext.txt'.format(sys.argv[1]), 'r') as f:
            self.data = f.readlines()

        # self.save_path = '../data/nuscenes/all_depth_train'
        self.save_path = '/mnt/nas/algorithm/wenjie.yuan/code/s3depth/data/nuscenes/depth_train'
        # self.save_path = '/mnt/cfs/algorithm/xianda.guo/code/wenjie.yuan/depth'
